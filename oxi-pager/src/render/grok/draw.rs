    ...
    let handle = std::thread::Builder::new()
        ...
        .spawn(move || -> std::io::Result<()> {
            ...
            let mut writer: Box<dyn std::io::Write> = {
                // OXI-CHANGE: was xai_tty_utils::dup_tui_stderr().unwrap_or_else(...)
                // — inlined dup() fallback only.
                let tui_out = {
            ...
            while let Ok(payload) = rx.recv() {
                ...
                let result = {
                    // OXI-CHANGE: was xai_grok_shared::stderr::stderr_lock(); no-op for oxi
...
pub fn draw_frame(
    ...
    render_fn: impl FnOnce(
        ...
        Option<(u16, u16)>,
        Option<crate::render::grok::terminal::overlay::PostFlush>,
    ),
) {
