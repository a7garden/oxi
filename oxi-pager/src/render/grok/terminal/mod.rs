...
use crate::render::grok::host::HostOs;
...
pub fn tmux_show_option(option: &str) -> Option<String> {
    ...
    // OXI-CHANGE: was xai_tty_utils::detach_std_command(&mut cmd);
...
impl TerminalContext {
    ...
    // OXI-CHANGE: telemetry_snapshot() and feedback_info() removed — they
    // depended on xai_grok_telemetry / xai_grok_shared crates not vendored.
}
...
fn collect_process_env() -> HashMap<String, String> {
    crate::render::grok::host::collect_unicode_env()
}
