...
/// (exec, memory, browser, persona, etc.) into the oxicode agent tool registry.
///
/// # Example
///
/// ```ignore
/// use oxicode_sdk::{KernelToolProvider, KernelToolContext};
/// use oxicode_agent::ToolRegistry;
///
...
mod tests {
    ...
    use oxicode_agent::{AgentTool, AgentToolResult, ToolContext, ToolError};
