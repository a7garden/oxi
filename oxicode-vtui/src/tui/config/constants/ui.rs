pub const TOOL_OUTPUT_MODE_COMPACT: &str =
    oxicode_vtui_compat::constants::ui::TOOL_OUTPUT_MODE_COMPACT;
pub const TOOL_OUTPUT_MODE_FULL: &str = oxicode_vtui_compat::constants::ui::TOOL_OUTPUT_MODE_FULL;
pub const DEFAULT_REASONING_VISIBLE: bool =
    oxicode_vtui_compat::constants::ui::DEFAULT_REASONING_VISIBLE;
...
pub const INLINE_PTY_PLACEHOLDER: &str = oxicode_vtui_compat::constants::ui::INLINE_PTY_PLACEHOLDER;
...
pub const HEADER_UNKNOWN_PLACEHOLDER: &str =
    oxicode_vtui_compat::constants::ui::HEADER_UNKNOWN_PLACEHOLDER;
...
pub const CHAT_INPUT_PLACEHOLDER_BOOTSTRAP: &str =
    oxicode_vtui_compat::constants::ui::CHAT_INPUT_PLACEHOLDER_BOOTSTRAP;
pub const CHAT_INPUT_PLACEHOLDER_FOLLOW_UP: &str =
    oxicode_vtui_compat::constants::ui::CHAT_INPUT_PLACEHOLDER_FOLLOW_UP;
...
pub const WELCOME_TEXT_WIDTH: usize = oxicode_vtui_compat::constants::ui::WELCOME_TEXT_WIDTH;
pub const WELCOME_SHORTCUT_SECTION_TITLE: &str =
    oxicode_vtui_compat::constants::ui::WELCOME_SHORTCUT_SECTION_TITLE;
pub const WELCOME_SHORTCUT_HINT_PREFIX: &str =
    oxicode_vtui_compat::constants::ui::WELCOME_SHORTCUT_HINT_PREFIX;
pub const WELCOME_SHORTCUT_SEPARATOR: &str =
    oxicode_vtui_compat::constants::ui::WELCOME_SHORTCUT_SEPARATOR;
pub const WELCOME_SHORTCUT_INDENT: &str =
    oxicode_vtui_compat::constants::ui::WELCOME_SHORTCUT_INDENT;
pub const WELCOME_SLASH_COMMAND_SECTION_TITLE: &str =
    oxicode_vtui_compat::constants::ui::WELCOME_SLASH_COMMAND_SECTION_TITLE;
pub const WELCOME_SLASH_COMMAND_LIMIT: usize =
    oxicode_vtui_compat::constants::ui::WELCOME_SLASH_COMMAND_LIMIT;
pub const WELCOME_SLASH_COMMAND_PREFIX: &str =
    oxicode_vtui_compat::constants::ui::WELCOME_SLASH_COMMAND_PREFIX;
pub const WELCOME_SLASH_COMMAND_INTRO: &str =
    oxicode_vtui_compat::constants::ui::WELCOME_SLASH_COMMAND_INTRO;
pub const WELCOME_SLASH_COMMAND_INDENT: &str =
    oxicode_vtui_compat::constants::ui::WELCOME_SLASH_COMMAND_INDENT;
