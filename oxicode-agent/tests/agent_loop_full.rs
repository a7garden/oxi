...
mod tests {
    ...
    impl Stream for MockStream {
        ...
        fn poll_next(
            ...
            let mut assistant =
                AssistantMessage::new(oxicode_ai::Api::AnthropicMessages, "mock", "mock-model");
    ...
    struct InbandTextProvider {
        texts: Vec<String>,
        call_count: Arc<AtomicUsize>,
        captured: Arc<parking_lot::Mutex<Vec<oxicode_ai::Context>>>,
    }
    ...
    impl Provider for InbandTextProvider {
        fn stream<'a>(
            ...
            Box::pin(async move {
                let mut assistant =
                    AssistantMessage::new(oxicode_ai::Api::OpenAiCompletions, "mock", "mock-model");
