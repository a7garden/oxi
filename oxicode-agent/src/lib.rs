...
//! oxicode-agent: Agent runtime for oxicode
//!
//! Provides the core agent loop, tool execution, state management,
//! and streaming event pipeline for the oxicode coding agent.
...
pub use oxicode_ai::{CompactionManager, CompactionStrategy};
...
/// In-process subagent runner trait (see [`SdkSubagentRunner`] in oxicode-sdk).
...
/// Standard imports for oxicode-agent usage.
pub mod prelude {
