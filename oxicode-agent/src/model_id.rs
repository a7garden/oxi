use oxicode_ai::Model;
use oxicode_ai::register_builtins::get_builtin_provider;
use oxicode_ai::{get_model, get_model_entry, lookup_model};
...
fn model_from_entry(provider: &str, entry: &oxicode_ai::model_db::ModelEntry) -> Model {
    ...
    let compat = match provider {
        "zai" => Some(oxicode_ai::CompatSettings {
            thinking_format: Some(oxicode_ai::ThinkingFormat::Zai),
            ..Default::default()
        }),
        _ => None,
    };
