...
pub enum AgentEvent {
    ...
    AgentStart {
        ...
        prompts: Vec<oxicode_ai::Message>,
    ...
    AgentEnd {
        ...
        messages: Vec<oxicode_ai::Message>,
    ...
    TurnEnd {
        ...
        assistant_message: oxicode_ai::Message,
        /// Tool results collected during this turn.
        tool_results: Vec<oxicode_ai::ToolResultMessage>,
    },
