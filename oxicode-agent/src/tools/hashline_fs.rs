...
//! `file_mutation_queue`.
//!
//! This is the bridge between the pure-function `oxicode-hashline` crate and the
//! oxicode-agent runtime. The `Patcher` calls these methods; security and
//! serialization are handled transparently.

use async_trait::async_trait;
use oxicode_hashline::mismatch::HashlineError;
use oxicode_hashline::patcher::HashlineFs;
