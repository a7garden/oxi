...
/// `#[oxicode_api_stability::stable(...)]` if you also need the built-in.
...
/// `#[oxicode_api_stability::deprecated(...)]` or by importing under a different
/// name (`use oxicode_api_stability::deprecated as oxicode_deprecated;`) if you also
/// need the built-in.
...
mod tests {
    ...
    // oxicode-sdk / oxicode-cli (Phase 2 Task 6+).
    //
    ...
    // `cargo build -p oxicode-api-stability` succeeds.
