...
//
// MIT licensed — provides the minimum surface area needed for oxi-vtui to compile.
...
pub mod constants {
    pub mod ui {
        ...
        pub const THEME_RELATIVE_LUMINANCE_CUTOFF: f32 = 0.5;
        pub const THEME_RELATIVE_LUMINANCE_LOW_FACTOR: f32 = 0.85;
        pub const THEME_RELATIVE_LUMINANCE_OFFSET: f32 = 0.05;
        pub const THEME_RELATIVE_LUMINANCE_EXPONENT: f32 = 1.5;
        pub const THEME_RED_LUMINANCE_COEFFICIENT: f32 = 0.299;
        pub const THEME_GREEN_LUMINANCE_COEFFICIENT: f32 = 0.587;
        pub const THEME_BLUE_LUMINANCE_COEFFICIENT: f32 = 0.114;
        ...
        pub const THEME_BLEND_CLAMP_MAX: f32 = 1.0;
        pub const THEME_COLOR_WHITE_RED: f32 = 0.299;
        pub const THEME_COLOR_WHITE_GREEN: f32 = 0.587;
        pub const THEME_COLOR_WHITE_BLUE: f32 = 0.114;
