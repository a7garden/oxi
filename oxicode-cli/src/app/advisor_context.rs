...
pub fn assemble_advisor_system_prompt(cwd: &str) -> String {
    let mut out = oxicode_agent::ADVISOR_SYSTEM_PROMPT.to_string();
...
///
/// Fed by [`AgentAdvisor::with_post_prompt_hook`](oxicode_agent::AgentAdvisor) —
...
impl AdvisorTranscriptRecorder {
    ...
    pub fn record(&self, agent: &oxicode_agent::Agent) {
        use std::io::Write;
