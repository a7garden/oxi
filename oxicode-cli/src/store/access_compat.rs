...
//!    `permissions.allow/deny/ask` arrays into oxicode `AccessGate` rule
...
//!   workspace hooks that oxicode doesn't share.

use std::path::{Path, PathBuf};

use serde::Deserialize;

use oxicode_sdk::ports::{AccessDecision, ToolCallRequest};
