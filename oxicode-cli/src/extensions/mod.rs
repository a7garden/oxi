...
pub use oxicode_agent::{AgentEvent, AgentTool, AgentToolResult};
...
// The Extension trait
/// Core trait that every oxicode extension must implement.
pub trait Extension: Send + Sync {
    ...
    fn register_tools(&self) -> Vec<std::sync::Arc<dyn oxicode_agent::AgentTool>> {
        vec![]
    }
    ...
    fn on_tool_result(&self, _tool: &str, _result: &oxicode_agent::AgentToolResult) {}
    ...
    fn on_event(&self, _event: &oxicode_agent::AgentEvent) {}
    ...
    fn on_after_tool_call(
        &self,
        _tool: &str,
        _result: &oxicode_agent::AgentToolResult,
    ) -> Result<(), anyhow::Error> {
        Ok(())
    }
...
impl Extension for RecordingExtension {
    ...
    fn on_tool_result(&self, tool: &str, _result: &oxicode_agent::AgentToolResult) {
