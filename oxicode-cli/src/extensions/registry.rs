...
type ToolType = dyn oxicode_agent::AgentTool;
...
impl ExtensionRunner {
    ...
    pub fn emit_context_event(&self, messages: Vec<oxicode_sdk::Message>) -> ContextEmitResult {
...
impl oxicode_agent::AgentTool for WrappedTool {
    fn name(&self) -> &str {
        self.inner.name()
    }
    fn label(&self) -> &str {
