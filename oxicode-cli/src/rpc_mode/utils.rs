...
// ============================================================================
// RPC Client (for programmatic access to an oxicode RPC server)
// ============================================================================

/// Configuration for the RPC client.
#[derive(Debug, Clone)]
pub struct RpcClientConfig {
    /// Path to the oxicode binary
...
/// RPC Client for programmatic access to an oxicode agent.
///
...
impl RpcClient {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        let child = cmd.spawn().context("Failed to spawn oxicode RPC process")?;
