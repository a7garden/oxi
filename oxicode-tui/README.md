...
**ratatui-based widgets, theming, and a differential-rendering backend for oxicode.**

[![Version](https://img.shields.io/badge/Version-0.39.0-blue?style=flat-square)](https://crates.io/search?q=oxicode)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg?style=flat-square)](../LICENSE.md)
[![Docs](https://img.shields.io/docsrs/oxicode-tui/latest?style=flat-square)](https://docs.rs/oxicode-tui)
...
`oxicode-tui` is a **widget, theme, and tape-rendering library** built on top of
[`ratatui`](https://docs.rs/ratatui) 0.30 + [`crossterm`](https://docs.rs/crossterm)
0.29. It does **not** ship its own event loop. Production oxicode-cli renders chat
...
> oxicode-tui has **no `oxicode-*` dependencies**. It is a pure widget library any
...
```toml
[dependencies]
oxicode-tui = { path = "path/to/oxicode-tui" }
ratatui = "0.30"
crossterm = "0.29"
```
...
```rust
use oxicode_tui::tape::{LiveRegion, TapeEngine};
use std::io::stdout;
...
```rust
use oxicode_tui::render::DiffBackend;
...
```rust
use oxicode_tui::{Theme, ThemeManager};
...
```rust
use oxicode_tui::{GlyphSet, Symbols};
...
```rust
use oxicode_tui::keybindings::{KeybindingsManager, keys::KeyId, registry::Action};
