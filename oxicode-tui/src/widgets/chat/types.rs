...
/// `oxicode_agent::advisor::AdvisorSeverity`; the conversion happens at the
/// boundary in `oxicode-cli/src/tui/handlers.rs` so `oxicode-tui` keeps its
/// "no oxicode-* deps" rule (see AGENTS.md).
