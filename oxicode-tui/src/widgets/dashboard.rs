...
//! widget is domain-agnostic: the oxicode-cli `McpDashboardOverlay` populates
...
//!
//! This keeps oxicode-tui MCP-free: there is no `oxicode-agent` or
//! `oxicode_sdk::mcp::*` import anywhere in this file.
