//! models.dev → oxi catalog materialization.
//!
...
/// Convert a [`MdCatalog`] into oxi's internal provider + model entries.
///
...
///
/// Models.dev does not know oxi-specific HTTP headers (e.g. `HTTP-Referer`
...
/// Normalize models.dev modalities to oxi input string list.
