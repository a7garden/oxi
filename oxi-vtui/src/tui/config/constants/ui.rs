...
pub const DEFAULT_REASONING_VISIBLE: bool =
    oxi_vtui_compat::constants::ui::DEFAULT_REASONING_VISIBLE;
...
pub const HEADER_UNKNOWN_PLACEHOLDER: &str =
    oxi_vtui_compat::constants::ui::HEADER_UNKNOWN_PLACEHOLDER;
...
pub const CHAT_INPUT_PLACEHOLDER_BOOTSTRAP: &str =
    oxi_vtui_compat::constants::ui::CHAT_INPUT_PLACEHOLDER_BOOTSTRAP;
pub const CHAT_INPUT_PLACEHOLDER_FOLLOW_UP: &str =
    oxi_vtui_compat::constants::ui::CHAT_INPUT_PLACEHOLDER_FOLLOW_UP;
...
pub const WELCOME_SHORTCUT_SECTION_TITLE: &str =
    oxi_vtui_compat::constants::ui::WELCOME_SHORTCUT_SECTION_TITLE;
pub const WELCOME_SHORTCUT_HINT_PREFIX: &str =
    oxi_vtui_compat::constants::ui::WELCOME_SHORTCUT_HINT_PREFIX;
pub const WELCOME_SHORTCUT_SEPARATOR: &str =
    oxi_vtui_compat::constants::ui::WELCOME_SHORTCUT_SEPARATOR;
...
pub const WELCOME_SLASH_COMMAND_SECTION_TITLE: &str =
    oxi_vtui_compat::constants::ui::WELCOME_SLASH_COMMAND_SECTION_TITLE;
pub const WELCOME_SLASH_COMMAND_LIMIT: usize =
    oxi_vtui_compat::constants::ui::WELCOME_SLASH_COMMAND_LIMIT;
pub const WELCOME_SLASH_COMMAND_PREFIX: &str =
    oxi_vtui_compat::constants::ui::WELCOME_SLASH_COMMAND_PREFIX;
pub const WELCOME_SLASH_COMMAND_INTRO: &str =
    oxi_vtui_compat::constants::ui::WELCOME_SLASH_COMMAND_INTRO;
pub const WELCOME_SLASH_COMMAND_INDENT: &str =
    oxi_vtui_compat::constants::ui::WELCOME_SLASH_COMMAND_INDENT;
