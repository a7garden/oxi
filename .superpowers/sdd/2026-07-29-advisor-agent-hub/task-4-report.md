...
```
$ cargo nextest run -p oxicode-cli app::agent_hub_bridge::tests
   PASS [   0.023s] (1/4) oxicode-cli app::agent_hub_bridge::tests::empty_dir_registers_nothing
   PASS [   0.024s] (2/4) oxicode-cli app::agent_hub_bridge::tests::main_session_stem_heuristic_matches_real_pattern
   PASS [   0.025s] (3/4) oxicode-cli app::agent_hub_bridge::tests::missing_dir_is_noop
   PASS [   0.032s] (4/4) oxicode-cli app::agent_hub_bridge::tests::registers_subagent_jsonl_excluding_main_and_advisor
...
- `cargo nextest run -p oxicode-cli app::agent_hub_bridge::tests` — **4/4 PASS** (added heuristic unit test)
- `cargo nextest run -p oxicode-cli` — **746/746 PASS** (no regressions)
