...
Added `oxi-tui/tests/chat_integration.rs` with two integration tests:
...
- `cargo nextest run -p oxi-tui --test chat_integration`: 2 passed, 0 skipped.
- `cargo nextest run -p oxi-tui`: 208 passed, 0 skipped.
- `cargo clippy -p oxi-tui -- -D warnings`: passed with no warnings.
