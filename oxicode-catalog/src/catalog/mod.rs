...
//! 2. LIVE — runtime cache (~/.oxicode/cache/) with ETag conditional GET
//! 3. Layer 2 — user override (~/.oxicode/catalog/overrides.toml)
...
pub use materialize::{
    ProductMeta, materialize, materialize_providers, product_meta_toml, snapshot_gzip_bytes,
};
