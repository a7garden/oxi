//! Build script for oxicode-catalog.
//!
...
//!
//! Set `OXICODE_CATALOG_SNAPSHOT=path` to inject a specific snapshot file
...
fn main() {
    ...
    // If OXICODE_CATALOG_SNAPSHOT is set, copy that file over the committed
