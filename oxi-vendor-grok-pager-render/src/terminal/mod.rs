...
impl TerminalContext {
    ...
    pub fn telemetry_snapshot(&self) -> oxi_vendor_grok_shim::telemetry::events::TerminalTelemetry {
        ...
        oxi_vendor_grok_shim::telemetry::events::TerminalTelemetry {
            ...
            clipboard_native_tool: oxi_vendor_grok_shim::clipboard::native_tool_name().to_owned(),
            clipboard_data_control: crate::clipboard::wayland_data_control_label().to_owned(),
        }
    }

    /// Extract terminal info for feedback submissions.
    pub fn feedback_info(&self) -> oxi_vendor_grok_shim::session::FeedbackTerminalInfo {
        use oxi_vendor_grok_shim::session::FeedbackTerminalInfo;
        ...
        FeedbackTerminalInfo {
            ...
            clipboard_native_tool: Some(oxi_vendor_grok_shim::clipboard::native_tool_name().to_owned()),
