...
//!
//! For local development, credentials should be stored via `oxicode setup` in
//! `~/.config/oxicode/auth.json`. This file-based approach is more reliable than
...
mod tests {
    ...
    fn test_get_all_env_keys() {
        ...
        let key = "OXICODE_TEST_GET_ALL_ENV_KEYS";
